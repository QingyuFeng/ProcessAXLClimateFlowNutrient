...
def read_var(siteidx):
    ...
    if os.path.isfile(inf_lst[siteidx]):
        print("Relative Humidity data exists! Good!!!")
    else:
        print("Relative Humidity data not exists! Please check!!!")
...
def writing_outfiles():
    ...
    print("Writing daily average relative humidity with next day filled")
    ...
    print("Writing daily average relative humidity with no filled")
